...
<div class="row layout-top-spacing" id="cancel-row">
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <?php
        if (session()->getFlashdata('tambah_pekerjaan')) {
            echo '<div class="alert alert-success" role="alert">';
            echo session()->getFlashdata('tambah_pekerjaan');
            echo '</div>';
        }
        ?>
        ...
        <div class="widget-content widget-content-area br-6">
            ...
            <table id="default-ordering" class="table table-hover" style="width:100%">
                ...
                <tbody>
                    <?php $no = 1;
                    foreach ($pekerjaan as $kerja => $value) { ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <td><?= $value['pekerjaan'] ?></td>
                            <td class="text-center">
                                <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editData<?= $value['id_pekerjaan'] ?>"> Edit</button>
                                <a href="<?= base_url('/C_Pekerjaan/deleteData/' . $value['id_pekerjaan']); ?>" class="btn btn-danger btn-sm"> Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Pekerjaan</h5>
            ...
            <?= form_open('C_Pekerjaan/tambahData') ?>

            <div class="modal-body">
                <div class="form-group mb-4">
                    <label for="formGroupExampleInput"><b>Pekerjaan</b></label>
...
<?php foreach ($pekerjaan as $key => $value) { ?>
    <div id="editData<?= $value['id_pekerjaan'] ?>" class="modal animated zoomInUp custo-zoomInUp" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <?= form_open('C_Pekerjaan/editData/' . $value['id_pekerjaan']) ?>

                <div class="modal-body">
                    <div class="form-group mb-4">
                        <label for="formGroupExampleInput"><b>Pekerjaan</b></label>
                        <input type="text" value="<?= $value['pekerjaan'] ?>" name="pekerjaan" class="form-control" id="formGroupExampleInput" placeholder="Pekerjaan">
                    </div>
                </div>
                <div class="modal-footer md-button">
                    <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Close</button>
